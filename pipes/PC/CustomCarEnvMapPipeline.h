...
//
//
#ifndef __PCCUSTOMCARENVMAPPIPELINE_H__
#define __PCCUSTOMCARENVMAPPIPELINE_H__

#ifdef GTA_XBOX
	#error "This sourcecode is NOT a part of GTA_XBOX build."
#endif

#include "d3d9.h"	// D3DLIGHT9
...
private:
	static D3DLIGHT9							m_gSpecularLight;	// global specular light used by the pipe
};
...
#endif//__PCCUSTOMCARENVMAPPIPELINE_H__...
