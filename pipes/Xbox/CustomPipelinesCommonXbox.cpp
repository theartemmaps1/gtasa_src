...
//	02/03/2005	- Andrzej:	- functions replacements for RW release libs build from source added;
//
//
//
//
...
//
//
#if 1	//#ifndef FINALBUILD
	#if defined(DEBUG)
		// everything is OK with DEBUG libs, no replacements required
	#else
	//
	// replacements for "missing" functions, which are not available in RW release libs built from source:
	//
